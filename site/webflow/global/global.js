/* ══════════════════════════════════════════════════════════════
   Webkit.Studio — GLOBÁLNÍ SKRIPT WEBU
   Patří do Webflow: Site settings → Custom code → Footer code.
   Platí pro každou stránku. Obsahuje jen to, co je společné:
     · hlášky, které se samy vypisují do pole „Co řešíte"
     · odkaz v patičce, který znovu vyvolá lištu se souhlasem
     · rotující slovo v nadpisu kontaktu
     · odhalování prvků při scrollu
   Co je jen na homepage (hero, Brzdí, ukázka, Služby, Postup),
   zůstává v embedu na konci té stránky.

   Sestaveno skriptem z page-home.js, needituj tenhle soubor ručně.
   ══════════════════════════════════════════════════════════════ */
(function(){
function boot(){
...
var rw=q('#wk-rotword');
if(rw&&!rw.dataset.wkRot){rw.dataset.wkRot='1';var ws=['web','značka','aplikace','projekt'],wi=0;
...
['#recenze .review_card',1],['#faq .faq_item',0],['#vyzva .cta_banner',0]];
var prvky=[];
